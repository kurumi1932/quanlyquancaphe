 ...
 * @author ThangIKCU
 */
public class jd_SoLuong extends javax.swing.JDialog {
     ...
     * @param MaHD
     */
    public jd_SoLuong(java.awt.Frame parent, boolean modal, String MaMon, String TenBan, int MaBan, float DonGia, String MaHD) {
        super(parent, modal);
        initComponents();
        mamon = MaMon;
        tenban = TenBan;
    ...
    private void btOKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btOKActionPerformed
        if (hd == null) {
            ...
            hdDAO.addHoaDon(hd1);
            HoaDon hd2 = hdDAO.getHoaDonByMaBan(maban);
            System.out.println("mahd1:" + hd1.getMahd());
            System.out.println("mamon1:" + mamon);
            cthd = cthdDAO.getCTHDbyMaHDAndMaMon(hd1.getMahd(), Integer.parseInt(mamon));

            if (cthd == null) {
                CTHoaDon cthd2 = new CTHoaDon();
                cthd2.setMahd(hd2.getMahd());
            ...
            jp_GoiMon.gm.lblGioDen.setText("Giờ đến: " + df.format(hd2.getGioden()));
            jp_GoiMon.gm.lblNV.setText("Người nhập: " + hd2.getTennv());
            jp_GoiMon.gm.lblMaHD.setText(hd2.getMahd());
            jp_GoiMon.gm.ModelCTHD.setRowCount(0);
            jp_GoiMon.gm.setDataCTHDtable(cthdDAO.getListCTHDbyMaHD(hd2.getMahd()));
            jp_GoiMon.gm.lblTrangThai.setText("Trạng thái: Đang phục vụ");
        } else {
            HoaDon hd2 = hdDAO.getHoaDonByMaBan(maban);
            System.out.println("mahd2:" + hd2.getMahd());
            System.out.println("mamon2:" + mamon);
            cthd = cthdDAO.getCTHDbyMaHDAndMaMon(hd2.getMahd(), Integer.parseInt(mamon));
            if (cthd == null) {
                CTHoaDon cthd2 = new CTHoaDon();
